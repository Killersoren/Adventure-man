...
{
    internal class GridPlatform : IntermidiateTemporaryClassForStoppingMovement
    {
        private int width;
        private int height;
        ...
        public GridPlatform(Vector2 pos, int width, int height)
        {
            Width = width;
            Height = height;
        ...
        public GridPlatform(int X, int Y, int width, int height)
        {
            Width = width;
            Height = height;
            int res = World.GridResulution;
